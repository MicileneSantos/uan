    ...
    public function actionCreate() {
        if  (Yii::$app->user->can('admin')){
            ...
            Yii::$app->getSession()->setFlash('info', [
                                                'type' => 'info',
                                                'duration' => 1200,
                                                'message' => 'Backup de dados gerado com sucesso!!!',
                                                'title' => 'SysUAN',
                                                'positonY' => 'top',
                                                'positonX' => 'center'
                                                ]);
            ...
            if (isset($file)) {
                ...
                if (file_exists($sqlFile)) {
                    ...
                    Yii::$app->getSession()->setFlash('info', [
                                                'type' => 'danger',
                                                'duration' => 1200,
                                                'message' => 'Backup de dados excluído com sucesso!!!',
                                                'title' => 'SysUAN',
                                                'positonY' => 'top',
                                                'positonX' => 'center'
                                                ]);
	...
	$file = $filename;
        ...
        if (isset($file)) {
            ...
            Yii::$app->getSession()->setFlash('info', [
                                                'type' => 'info',
                                                'duration' => 1200,
                                                'message' => 'Backup de dados restaurado com sucesso!!!',
                                                'title' => 'SysUAN',
                                                'positonY' => 'top',
                                                'positonX' => 'center'
                                                ]);
            ...
            Yii::$app->getSession()->setFlash('info', [
                                                'type' => 'info',
                                                'duration' => 1200,
                                                'message' => 'Erro: nome de arquivo incorreto!!!',
                                                'title' => 'SysUAN',
                                                'positonY' => 'top',
                                                'positonX' => 'center'
                                                ]);
